...
def get_info(message):
    ...
    itemp4_yes = ty.InlineKeyboardButton(text='Можешь спросить у меня дадададад', callback_data='yes_3')
    itemp5_yes = ty.InlineKeyboardButton(text='Можешь спросить у меня дадададаffffffffffffд', callback_data='yes_4')
